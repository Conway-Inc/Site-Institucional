...
function cadastrarEmpresa(email, senha, cnpj, representante, ramo, nome, cpf) {
  ...
  instrucao2 = `INSERT INTO Funcionario(nomeFunc, emailFunc, senhaFunc, fkEmpresa, cpfFunc) VALUES ('${representante}', '${email}', '${senha}', (SELECT LAST_INSERT_ID(idEmpresa) from Empresa ORDER BY idEmpresa DESC limit 1), '${cpf}');`
