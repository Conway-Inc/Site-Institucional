function calcularEficiencia() {
    ...
    if (rank == "Ruim") {
        ...
        document.getElementById("dados").innerHTML += `A linha não está eficiente, ela pode melhorar usando nosso sistema.`
    }
    else if (rank == "Bom") {
        document.getElementById("dados").innerHTML += `A linha está eficiente, mas pode melhorar usando nosso sistema.`
    }
    else if (rank == "Excelente") {
        document.getElementById("dados").innerHTML = `A linha está em sua eficiência máxima, se você deseja manter esse padrão e se preparar para crises contate a Conway.`
    }
    else if (rank == "Superlotado") {
        document.getElementById("dados").innerHTML += `A linha está sofrendo com superlotação, se você deseja corrigir esse problema, contate a Conway.`
    }
